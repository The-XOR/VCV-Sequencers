...
{	
	return compare ? voltNear(v1, v2) : v1 > v2;
}
...
{
	/*
	s=0 e r=1 il flip-flop si resetta, cio� porta a 0 il valore della variabile d'uscita q 
	s=1 e r=0 il flip-flop si setta cio� porta a 1 il valore della variabile d'uscita q 
	s=0 e r=0 il flip-flop conserva, cio� mantiene inalterato 
